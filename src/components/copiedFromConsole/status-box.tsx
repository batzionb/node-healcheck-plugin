...
//         <img
//           className="cos-status-box__access-denied-icon"
//           src={restrictedSignImg}
//         />
//         <MsgBox
...
export const StatusBox: React.FC<StatusBoxProps> = ({ children }) => {
  ...
  return <div>status box placeholder</div>;
};
